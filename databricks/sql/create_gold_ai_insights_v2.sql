-- DataRadar - Tabela Gold AI Insights (Community Edition)
...
-- LOCATION removido - Community Edition usa DBFS managed storage
...
-- Ver localização da tabela (DBFS path)
DESCRIBE EXTENDED gold_ai_insights;
